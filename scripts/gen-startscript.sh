...
# USD SW; two alliance blocks. Mid pair (SOL) is land-locked: no ship or hover
...
[GAME]
{
    ...
    [AI0] { Name=SOL;       ShortName=BARb; Host=0; Team=0; [OPTIONS] { disabledunits=$AI_DISABLED_UNITS_MID; } }
    [AI1] { Name=USD-SOL;   ShortName=BARb; Host=0; Team=1; [OPTIONS] { disabledunits=$AI_DISABLED_UNITS_MID; } }
    ...
    [AI6] { Name=BAM;       ShortName=BARb; Host=0; Team=6; [OPTIONS] { disabledunits=$AI_DISABLED_UNITS_BAM; } }
    [AI7] { Name=USD-BAM;   ShortName=BARb; Host=0; Team=7; [OPTIONS] { disabledunits=$AI_DISABLED_UNITS_BAM; } }
